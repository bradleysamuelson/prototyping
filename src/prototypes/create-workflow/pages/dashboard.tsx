...
import { Button, ButtonTheme, Card, CardTheme, Notification, NotificationTheme, Search } from '@preamp/core';
                    ...
                    {dataType === 'alldata' && (
                        <div>
                            ...
                            {/* <Menu
                                ...
                                onClose={onCloseBasicMenu}
                                open={Boolean(basicAnchorEl)}
                            >
                                <MenuItem ><Button theme={ButtonTheme.Link} onClick={onCreateSetData('create', 'pixels')} >Create a Pixel</Button></MenuItem>
                                <MenuItem ><Button theme={ButtonTheme.Link} onClick={onCreateSetData('create', 'creatives')}>Create a Creative</Button></MenuItem>
                            </Menu> */}
                        </div>
                    )}
                    {dataType != 'alldata' && (
