...
function Access() {
	...
	const [expandPanelAudience, setExpandPanelAudience] = React.useState<boolean>(false);
	...
	function onFilterButtonSelect(item:string): any {
		if (item === 'strategy') {
			if ( viewPills.pillPlanning && viewPills.pillOptimization && viewPills.pillMeasurement && viewPills.pillConfiguration) {
				onFilterViewAll();
			} else if (!viewPills.pillViewAll && viewPills.pillStrategy && !viewPills.pillPlanning && !viewPills.pillOptimization && !viewPills.pillMeasurement && !viewPills.pillConfiguration){
				onFilterViewAll();
			} else {
		...
		if (item === 'planning') {
			if ( viewPills.pillStrategy && viewPills.pillOptimization && viewPills.pillMeasurement && viewPills.pillConfiguration) {
				onFilterViewAll();
			} else if (!viewPills.pillViewAll && !viewPills.pillStrategy && viewPills.pillPlanning && !viewPills.pillOptimization && !viewPills.pillMeasurement && !viewPills.pillConfiguration){
				onFilterViewAll();
			} else {
		...
		if (item === 'optimization') {
			if ( viewPills.pillStrategy && viewPills.pillPlanning && viewPills.pillMeasurement && viewPills.pillConfiguration) {
				onFilterViewAll();
			} else if (!viewPills.pillViewAll && !viewPills.pillStrategy && !viewPills.pillPlanning && viewPills.pillOptimization && !viewPills.pillMeasurement && !viewPills.pillConfiguration){
				onFilterViewAll();
			} else {
		...
		if (item === 'measurement') {
			if ( viewPills.pillStrategy && viewPills.pillPlanning && viewPills.pillOptimization && viewPills.pillConfiguration) {
				onFilterViewAll();
			} else if (!viewPills.pillViewAll && !viewPills.pillStrategy && !viewPills.pillPlanning && !viewPills.pillOptimization && viewPills.pillMeasurement && !viewPills.pillConfiguration){
				onFilterViewAll();
			} else {
		...
		if (item === 'configuration') {
			if ( viewPills.pillStrategy && viewPills.pillPlanning && viewPills.pillOptimization && viewPills.pillMeasurement) {
				onFilterViewAll();
			} else if (!viewPills.pillViewAll && !viewPills.pillStrategy && !viewPills.pillPlanning && !viewPills.pillOptimization && !viewPills.pillMeasurement && viewPills.pillConfiguration){
				onFilterViewAll();
			} else {
							...
							<div className='brand-ui-header'>
								...
								<ul className='va-tabs dashboard-tabs' role='tablist'>
									<li className={cx('va-tab-item', { 'va-tab-item--active': viewTab === 'capabilities'})}>
										<a href="javascript:Void(0)" className='va-tab-item__link' role='tab' onClick={(): void => setViewTab('capabilities')}>Capabilities</a>
									</li>
