...
export const NationalRatings: React.FC<any> = ({selectedNav, latestObject, latestType, latestStatus, ...rest}) => {
    ...
    return (
            ...
            <div className="content-header">
                <div className='content-header-left'>
                    ...
                    <h1 className='page-title'>National Ratings</h1>
                </div>
                ...
                <div className='content-main-left'>
                   <div className='content-main-sticky'>
                        ...
                        <div className='list-header'>
                            ...
                            <div className='list-col-status'>Start Date</div>
                            <div className='list-col-source'>End Date</div>
                            ...
                            <div className='list-row' key={index}>
                                <div className='list-row-left'>
                                    ...
                                    <div className='list-col-source'>
                                        <div className='list-item'>{option.end}</div>
                                    </div>
                                </div>
