...
export const LinearPlans: React.FC<any> = ({selectedNav, ...rest}) => {
    React.useEffect(() => {
        selectedNav('linear-plans');
    }, []);
    return (
        ...
        <div className='page-content'>
            <div className="content-header">
                <div className='content-header-left'>
                    ...
                    <h1 className='page-title'>Legacy Linear Plans</h1>
                </div>
                <div className='content-header-right'>
                    <Button className='va-btn-lg' 
                        // onClick={() => history.push(`${url}/create`)}
                    >Create a Linear Plan</Button>
                </div>
            </div>
