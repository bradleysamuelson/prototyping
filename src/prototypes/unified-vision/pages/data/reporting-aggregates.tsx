...
export const ReportingAggregates: React.FC<any> = ({selectedNav, ...rest}) => {
    const history = useHistory();
    const { url } = useRouteMatch();
    React.useEffect(() => {
        selectedNav('reporting-aggregates');
    }, []);
    return (
            ...
            <div className="content-header content-header-tabs">
                <div className='content-header-upper'>
                    <div className='content-header-left'>
                        ...
                        <h1 className='page-title'>Reporting Aggregates</h1>
                    </div>
                ...
                <div className='content-header-tab-container'>
                    <ul className="va-tabs" data-ui="tabs" role="tablist">
                        <li className="va-tab-item va-tab-item--active">
                            <a aria-selected="true" className="va-tab-item__link" role="tab">Media Metrics</a>
                        </li>
                        <li className="va-tab-item">
                            <a aria-selected="false" className="va-tab-item__link" role="tab">Response Metrics</a>
                        </li>
                        <li className="va-tab-item ">
                            <a className="va-tab-item__link" role="tab">Business Metrics</a>
                        </li>
                    </ul>
                </div>
            </div>
            <div className='content-main'>
                <div className='placeholder-container placeholder-container-full'>Reporting Aggregates landing screen</div>
            </div>
