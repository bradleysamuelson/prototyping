...
export const InventorySources: React.FC<any> = ({selectedNav, ...rest}) => {
    const history = useHistory();
    const { url } = useRouteMatch();

    React.useEffect(() => {
        selectedNav('inventory-sources');
    }, []);
    return (
        <div className='page-content'>
            ...
            <div className='content-main'>
                <div className='placeholder-container placeholder-container-full'>Inventory Sources</div>
            </div>
